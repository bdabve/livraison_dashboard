...
selected_prevendeur_totals = global_tab.multiselect(
    ...
    default=df_mois["PREVENDEUR"].unique(),
...
df_total_par_mois = utils.build_totals_mois(df_mois, selected_prevendeur_totals)
...
render_prevendeur_tab(st, prevendeur_tab, df_mois, selected_month, df_selected_month)
